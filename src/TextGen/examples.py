...
**Logline:** In the following story, James finds a well in his backyard that is haunted by the ghost of Sam. The main characters are James and Sam.
...
Place: The backyard.
Plot element: Beginning.
Beat: James is weeding his garden in the backyard, the ghost of Sam is rummaging around in the well. James listens closely and hears the murmurs of Sam down the well. James unearths the opening to the well, and looks down to see a glimmering reflection.

Place: The well.
Plot element: Middle.
Beat: James is making his way down the well, Sam's voice is reverberating on the walls of the well. Sam tells the story of how he came to haunt the well. James offers to help set the soul of Sam free.

Place: The house.
Plot element: Conclusion.
Beat: Looking at a photo of the gardden featuring Sam, James says his goodbyes to Sam, Sam thanks James for his help. The ghost of Sam is set free after and James goes living his life.
...
Here is an example of a logline, a list of characters, and a list of plot points.
GENERATED "Beat" elements must be less than 120 words long!!
GENERATED "Beat" ELEMENTS MUST BE LESS THAN 120 WORDS LONG!!
...
Avoid repeating phrases and keep the description concise.
...
Using the examples above and the following logine and location name, GENERATE location description.
