...
from TextGen.ScriptGen.agents.agent_framework import run_agents, batch_character_agent_call
...
def main():
    ...
    from TextGen.ScriptGen.agents.agent_framework import DirectorAgent, DramaturgeAgent
